Anonymitycash version 1.0.7 is now available from:

  https://github.com/Anonymitycash/anonymitycash/releases/tag/v1.0.7
...
+ `PR #1455`
    - Node support using SOCKS5 connect to Anonymitycash network through a proxy server.
+ `PR #1459`
...
+ `PR #1473`
    - Support Mac using brew to install Anonymitycash.
