...
import (
	...
	"github.com/anonymitycash/anonymitycash/node"
)
...
var runNodeCmd = &cobra.Command{
	Use:   "node",
	Short: "Run the anonymitycashd",
	RunE:  runNode,
}

func init() {
	runNodeCmd.Flags().String("prof_laddr", config.ProfListenAddress, "Use http to profile anonymitycashd programs")
	...
	runNodeCmd.Flags().String("p2p.keep_dial", config.P2P.KeepDial, "Peers addresses try keeping connecting to, separated by ',' (for example \"1.1.1.1:46654;2.2.2.2:46653\")")
