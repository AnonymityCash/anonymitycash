...
import (
	...
	"github.com/anonymitycash/anonymitycash/cmd/anonymitycashd/commands"
...
func init() {
	...
	// If environment variable ANONYMITYCASH_DEBUG is not empty,
	// then add the hook to logrus and set the log level to DEBUG
	if os.Getenv("ANONYMITYCASH_DEBUG") != "" {
