/* AnonymitycashPoW.h */
#ifndef ANONYMITYCASHPOW_H
#define ANONYMITYCASHPOW_H
...
struct AnonymitycashMatList16 {
    ...
    // void copyFrom(AnonymitycashMatList8& other) {
    //     for(int i=0; i<256; i++) {
    //         matVec[i]->copyFrom(*other.matVec[i]);
    //     }
    // }

    // void copyFrom(AnonymitycashMatList16& other) {
    //     for(int i=0; i<256; i++) {
    //         matVec[i]->copyFrom(*other.matVec[i]);
    //     }
    // }
...
// extern AnonymitycashMatList8* matList_int8;
extern AnonymitycashMatList16* matList_int16;

inline void iter_mineAnonymitycash(const uint8_t *fixedMessage,
                            uint32_t len,
                            // uint8_t nonce[8],
                            uint8_t result[32]) {
...
// inline int test_mineAnonymitycash(
...
//     iter_mineAnonymitycash(fixedMessage,100,nonce,result);
//     std::cerr<<"Mine step "<<step<<std::endl;
//     for (int i = 0; i < 32; i++) {
//       printf("%02x ", result[i]);
//       if (i % 8 == 7)
