...
func randPeer() *Peer {
	return &Peer{
		Key: cmn.RandStr(12),
		NodeInfo: &NodeInfo{
			RemoteAddr: cmn.Fmt("%v.%v.%v.%v:46655", rand.Int()%256, rand.Int()%256, rand.Int()%256, rand.Int()%256),
			ListenAddr: cmn.Fmt("%v.%v.%v.%v:46655", rand.Int()%256, rand.Int()%256, rand.Int()%256, rand.Int()%256),
		},
	}
}
