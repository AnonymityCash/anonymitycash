// Package account stores and tracks accounts within a Anonymitycash Core.
package account
...
import (
	...
	"github.com/anonymitycash/anonymitycash/blockchain/signers"
	"github.com/anonymitycash/anonymitycash/blockchain/txbuilder"
	"github.com/anonymitycash/anonymitycash/common"
	"github.com/anonymitycash/anonymitycash/consensus"
	"github.com/anonymitycash/anonymitycash/consensus/segwit"
	"github.com/anonymitycash/anonymitycash/crypto"
	"github.com/anonymitycash/anonymitycash/crypto/ed25519/chainkd"
	"github.com/anonymitycash/anonymitycash/crypto/sha3pool"
	...
	"github.com/anonymitycash/anonymitycash/protocol/vm/vmutil"
)
...
// pre-define errors for supporting anonymitycash errorFormatter
var (
...
// Account is structure of Anonymitycash account
type Account struct {
	*signers.Signer
	ID    string `json:"id"`
