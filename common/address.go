...
import (
	...
	"github.com/anonymitycash/anonymitycash/common/bech32"
...
//
// The anonymitycash network the address is associated with is extracted if possible.
// When the address does not encode the network, such as in the case of a raw
// public key, the address will be associated with the passed defaultNet.
func DecodeAddress(addr string, param *consensus.Params) (Address, error) {
	// Bech32 encoded segwit addresses start with a human-readable part
	// (hrp) followed by '1'. For Anonymitycash mainnet the hrp is "bm", and for
...
// with the passed anonymitycash network.
// Part of the Address interface.
