...
import (
	...
	"github.com/anonymitycash/anonymitycash/net/http/reqid"
)

// Anonymitycash-specific header fields
const (
	HeaderBlockchainID = "Blockchain-ID"
	HeaderCoreID       = "Anonymitycash-Core-ID"
...
// A Client is a Anonymitycash RPC client. It performs RPCs over HTTP using JSON
...
func (c Client) userAgent() string {
	return fmt.Sprintf("Anonymitycash; process=%s; buildtag=%s; blockchainID=%s",
