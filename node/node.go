...
import (
	...
	"github.com/anonymitycash/anonymitycash/accesstoken"
	"github.com/anonymitycash/anonymitycash/account"
	"github.com/anonymitycash/anonymitycash/api"
	"github.com/anonymitycash/anonymitycash/asset"
	"github.com/anonymitycash/anonymitycash/blockchain/pseudohsm"
	"github.com/anonymitycash/anonymitycash/blockchain/txfeed"
	cfg "github.com/anonymitycash/anonymitycash/config"
	"github.com/anonymitycash/anonymitycash/consensus"
	"github.com/anonymitycash/anonymitycash/database"
	dbm "github.com/anonymitycash/anonymitycash/database/leveldb"
	"github.com/anonymitycash/anonymitycash/env"
	"github.com/anonymitycash/anonymitycash/event"
	anonymitycashLog "github.com/anonymitycash/anonymitycash/log"
	"github.com/anonymitycash/anonymitycash/mining/cpuminer"
	"github.com/anonymitycash/anonymitycash/mining/miningpool"
	"github.com/anonymitycash/anonymitycash/mining/tensority"
	"github.com/anonymitycash/anonymitycash/net/websocket"
	"github.com/anonymitycash/anonymitycash/netsync"
	"github.com/anonymitycash/anonymitycash/p2p"
	"github.com/anonymitycash/anonymitycash/protocol"
	w "github.com/anonymitycash/anonymitycash/wallet"
)
...
// Node represent anonymitycash node
type Node struct {
	cmn.BaseService
...
// NewNode create anonymitycash node
func NewNode(config *cfg.Config) *Node {
	...
	if err := anonymitycashLog.InitLogFile(config); err != nil {
	...
	if profileHost != "" {
		// Profiling anonymitycashd programs.see (https://blog.golang.org/profiling-go-programs)
