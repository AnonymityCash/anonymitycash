/*
Package equity provides a compiler for Anonymitycash's Equity contract language.
...
nodes in a Anonymitycash network can determine whether a proposed spend is
valid.
